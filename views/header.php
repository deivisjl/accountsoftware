...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="views/plugins/datatables/jquery.dataTables.min.css">
...
<div class="wrapper" style="height: auto;">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-lg"><b>Account </b>Soft</span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs">Emilio Hernandez</span>
            </a>
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  Emilio Hernandez - Web Developer
                  <small>Octubre 2017</small>
                </p>
              </li>
              <!-- Menu Body -->
              <li class="user-body">
